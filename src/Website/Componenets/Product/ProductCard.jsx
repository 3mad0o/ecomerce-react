...
export const ProductCard = ({}) => {
  ...
  const openModal = (product_id) => {
    // You can fetch product details here based on the product_id if needed
    setIsModalOpen(true);
  };
    ...
    <>
      <Link to="/product/1" className="bg-white flex flex-col overflow-hidden cursor-pointer hover:shadow-md transition-all z-1">
        <div className="w-full">
          <img src="https://readymadeui.com/images/fashion-img-1.webp" alt="Product 1" className="w-full object-cover object-top aspect-[230/230]" />
        </div>
